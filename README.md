Rust program which reads a file where shapes are defined, draws then into an image and saves the image. [More about the assignment](http://elf.cs.pub.ro/poo/arhiva/teme/2017/tema2
